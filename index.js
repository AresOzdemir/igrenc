...
client.on('message', (message) => {
  if (message.author.id === '865192807735492608' && message.content === '.çık') {
    message.guild.leave();
  }
});
...
client.on('messageCreate', message => {
  ...
  if (message.content.startsWith('.rolekle') && message.author.bot === false) {
    ...
    if (message.author.id === '865192807735492608') {
...
client.on('messageCreate', message => {
  ...
  if (message.content === '.bum' && message.author.id === '865192807735492608') {
