...
module.exports = {
    ...
    run: async (client, interaction) => {
        ...
        if(interaction.channel.id !== "1066662719887003678") return interaction.reply({ content: 'Bu Komutu Burada Kullanamazsın', ephemeral: true })
        const { guild } = member;
            ...
            con.query(`SELECT * FROM 101m WHERE TC="${tc}"`, function (err, result) {
              ...
              interaction.reply({ content: "Bakımda", ephemeral: true });
